...
This template does not apply changes — execution belongs in a `migration` plan (external-driven code
rewrites) or `refactor` plan (internal restructures). Record coverage; hand it to that plan.
